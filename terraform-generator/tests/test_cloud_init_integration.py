...
sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(__file__)), 'validators'))
...
def test_cloud_init_integration():
    ...
    topology_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "topology.json")
