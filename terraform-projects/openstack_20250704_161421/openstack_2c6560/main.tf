...
module "instance" {
  ...
  image_name  = lookup({"master_2c6560": {"image": "ubuntu-jammy", "flavor": "m2"}, "worker1_2c6560": {"image": "ubuntu-jammy", "flavor": "m2"}}, each.key, {}).image
  flavor_name = lookup({"master_2c6560": {"image": "ubuntu-jammy", "flavor": "m2"}, "worker1_2c6560": {"image": "ubuntu-jammy", "flavor": "m2"}}, each.key, {}).flavor
