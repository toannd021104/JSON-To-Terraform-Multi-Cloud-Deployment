# Config tự động - Phiên bản e7d6a9
        terraform {
        ...
        image_name    = lookup({"vm1_e7d6a9": {"image": "Ubuntu 16", "flavor": "m2"}, "s2_e7d6a9": {"image": "Ubuntu 16", "flavor": "m2"}}, each.key, {}).image
        flavor_name   = lookup({"vm1_e7d6a9": {"image": "Ubuntu 16", "flavor": "m2"}, "s2_e7d6a9": {"image": "Ubuntu 16", "flavor": "m2"}}, each.key, {}).flavor
