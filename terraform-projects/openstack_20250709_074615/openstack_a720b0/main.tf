...
module "instance" {
  ...
  image_name  = lookup({"vm1_a720b0": {"image": "ubuntu-jammy", "flavor": "m2"}, "s2_a720b0": {"image": "ubuntu-jammy", "flavor": "m2"}}, each.key, {}).image
  flavor_name = lookup({"vm1_a720b0": {"image": "ubuntu-jammy", "flavor": "m2"}, "s2_a720b0": {"image": "ubuntu-jammy", "flavor": "m2"}}, each.key, {}).flavor
