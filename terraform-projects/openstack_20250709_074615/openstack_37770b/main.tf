...
module "instance" {
  ...
  image_name  = lookup({"vm1_37770b": {"image": "ubuntu-jammy", "flavor": "m2"}, "s2_37770b": {"image": "ubuntu-jammy", "flavor": "m2"}}, each.key, {}).image
  flavor_name = lookup({"vm1_37770b": {"image": "ubuntu-jammy", "flavor": "m2"}, "s2_37770b": {"image": "ubuntu-jammy", "flavor": "m2"}}, each.key, {}).flavor
