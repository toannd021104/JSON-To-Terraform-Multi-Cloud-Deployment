...
module "instance" {
  ...
  image_name  = lookup({"master_c53923": {"image": "ubuntu-jammy", "flavor": "m2"}, "worker1_c53923": {"image": "ubuntu-jammy", "flavor": "m2"}}, each.key, {}).image
  flavor_name = lookup({"master_c53923": {"image": "ubuntu-jammy", "flavor": "m2"}, "worker1_c53923": {"image": "ubuntu-jammy", "flavor": "m2"}}, each.key, {}).flavor
