...
module "instance" {
  ...
  image_name  = lookup({"vm1_7cd446": {"image": "ubuntu-jammy", "flavor": "m2"}, "s2_7cd446": {"image": "ubuntu-jammy", "flavor": "m2"}}, each.key, {}).image
  flavor_name = lookup({"vm1_7cd446": {"image": "ubuntu-jammy", "flavor": "m2"}, "s2_7cd446": {"image": "ubuntu-jammy", "flavor": "m2"}}, each.key, {}).flavor
