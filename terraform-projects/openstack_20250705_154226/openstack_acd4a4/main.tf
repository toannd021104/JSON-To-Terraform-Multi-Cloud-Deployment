...
module "instance" {
  ...
  image_name  = lookup({"vm1_acd4a4": {"image": "ubuntu-jammy", "flavor": "m2"}, "s2_acd4a4": {"image": "ubuntu-jammy", "flavor": "m2"}}, each.key, {}).image
  flavor_name = lookup({"vm1_acd4a4": {"image": "ubuntu-jammy", "flavor": "m2"}, "s2_acd4a4": {"image": "ubuntu-jammy", "flavor": "m2"}}, each.key, {}).flavor
