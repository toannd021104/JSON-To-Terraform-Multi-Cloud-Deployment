# Config tự động - Phiên bản 0db904
        terraform {
        ...
        image_name    = lookup({"vm1_0db904": {"image": "Ubuntu 16", "flavor": "m2"}, "s2_0db904": {"image": "Ubuntu 16", "flavor": "m2"}}, each.key, {}).image
        flavor_name   = lookup({"vm1_0db904": {"image": "Ubuntu 16", "flavor": "m2"}, "s2_0db904": {"image": "Ubuntu 16", "flavor": "m2"}}, each.key, {}).flavor
