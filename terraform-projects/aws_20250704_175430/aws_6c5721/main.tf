...
module "instance" {
  ...
  ami_id            = lookup({"master_6c5721": {"ami": "ami-03f8acd418785369b", "instance_type": "t3.medium"}, "worker_6c5721": {"ami": "ami-03f8acd418785369b", "instance_type": "t3.medium"}}, each.key, {}).ami
  instance_type     = lookup({"master_6c5721": {"ami": "ami-03f8acd418785369b", "instance_type": "t3.medium"}, "worker_6c5721": {"ami": "ami-03f8acd418785369b", "instance_type": "t3.medium"}}, each.key, {}).instance_type
