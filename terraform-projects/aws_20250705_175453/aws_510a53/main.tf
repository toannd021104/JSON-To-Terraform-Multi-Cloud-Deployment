...
module "instance" {
  ...
  ami_id            = lookup({"vm1_510a53": {"ami": "ami-03f8acd418785369b", "instance_type": "t3.medium"}, "s2_510a53": {"ami": "ami-03f8acd418785369b", "instance_type": "t3.medium"}}, each.key, {}).ami
  instance_type     = lookup({"vm1_510a53": {"ami": "ami-03f8acd418785369b", "instance_type": "t3.medium"}, "s2_510a53": {"ami": "ami-03f8acd418785369b", "instance_type": "t3.medium"}}, each.key, {}).instance_type
